...
class LocalCodeInterpreter(BaseCodeInterpreter):
    ...
    def _pre_execute_code(self):
        init_code = (
            ...
            f"    'font.sans-serif': ['SimHei', 'Microsoft YaHei', 'SimSun', 'DejaVu Sans'],\n"
            ...
            f"}})\n"
            # 学术配色方案
            f"COLORS = ['#2E5B88', '#E85D4C', '#4A9B7F', '#F5A623', '#7F7F7F', '#B8D4E8', '#D4A5A5', '#9B59B6']\n"
            f"plt.gca().set_prop_cycle(color=COLORS)\n"
            f"print('学术图表样式已配置')\n"
        )
